...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
       ...
       newsen = Sentence(set(nbcells),count)
       print("Newsen Count")
       print(newsen.count)
       print("NBcells")
       print(nbcells)
       ...
       for sentence in self.knowledge:
           ...
           if ns.issubset(sentence.cells) or sentence.cells.issubset(ns):
               if ns.issubset(sentence.cells):
                   addsen=sentence.cells.difference(ns)
               else:
                   addsen=ns.difference(sentence.cells)

       self.knowledge.append(addsen)
    ...
    def make_safe_move(self):
        for self.safe in self.safes:
            if self.safe not in self.moves_made:
                return(self.safe)
